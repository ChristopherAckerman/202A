...
\label{sec:orgdc677ba}
\subsection{Stochastic Growth}
\label{sec:orgf3d4f40}
...
\subsection{Application to the stochastic growth model}
\label{sec:orge0ab936}
\begin{align*}
...
\label{sec:org270fafe}
\section{Relationship between AR and MC}
\label{sec:orgc0f320b}
   \begin{equation}
